...
public class Student1 {
	...
	public Student1(int id, String name, String college, int roll, String qualification, String course, int year,
	...
	public String toString() {
		return "Student1 [id=" + id + ", name=" + name + ", college=" + college + ", roll=" + roll + ", qualification="
